...
while True:
    ...
    if(emptyslot!=0):
        ...
        print("Sorry,parking slots are NOT AVAILABLE!!")
    ...
    data={"available_slot":emptyslot}
    def myonpublishcallback():
        print("Number of vacant slots are %s"% emptyslot)
        
    success=devicecli.publishEvent("Vacant slots","json",data,qos=1,on_publish=myonpublishcallback())
